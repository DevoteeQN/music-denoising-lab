...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run residual CNN spectrogram denoising on an audio file.")
    ...
    print(f"Wrote CNN output: {args.output}")
    print(f"Wrote CNN MP3: {Path(args.output).with_suffix('.mp3')}")
